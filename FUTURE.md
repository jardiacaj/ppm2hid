...
* I'm still seeing virtual device name "ppm2joy"
* Help me understand how to unlock high sample rates (192kHz). Just setting it in the program does not seem to be enough, the read data is still 48kHz
* Make profile mandatory CLI argument
* Convert current three-way slider implementation to an n-way slider
